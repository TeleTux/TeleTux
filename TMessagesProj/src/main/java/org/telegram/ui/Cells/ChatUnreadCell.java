...
public class ChatUnreadCell extends FrameLayout {
    ...
    public ChatUnreadCell(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        backgroundLayout.getBackground().setColorFilter(new PorterDuffColorFilter(getColor(Theme.key_chat_unreadMessagesStartBackground), PorterDuff.Mode.SRC_IN));
        ...
        imageView.setColorFilter(new PorterDuffColorFilter(getColor(Theme.key_chat_unreadMessagesStartArrowIcon), PorterDuff.Mode.SRC_IN));
