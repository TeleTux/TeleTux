...
public class Switch extends CompoundButton {
    ...
    public void setChecked(boolean checked) {
        ...
        if (mThumbDrawable != null) {
            mThumbDrawable.setColorFilter(new PorterDuffColorFilter(checked ? Theme.getColor(Theme.key_switchTrackBlueThumbChecked) : Theme.getColor(Theme.key_switchTrackBlueThumb), PorterDuff.Mode.MULTIPLY));
        }
    }
    ...
    public void checkColorFilters() {
        ...
        if (mThumbDrawable != null) {
            mThumbDrawable.setColorFilter(new PorterDuffColorFilter(isChecked() ? Theme.getColor(Theme.key_switchTrackBlueThumbChecked) : Theme.getColor(Theme.key_switchTrackBlueThumb), PorterDuff.Mode.MULTIPLY));
        }
    }
